...
void MX_GPIO_Init(void)
{
    ...
    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(TB6612_BIN1_GPIO_Port, TB6612_BIN1_Pin | TB6612_BIN2_Pin, GPIO_PIN_RESET);
    ...
    /*Configure TB6612 GPIO pins : BIN1, BIN2, STBY */
    GPIO_InitStruct.Pin = TB6612_BIN1_Pin | TB6612_BIN2_Pin | TB6612_STBY_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(TB6612_BIN1_GPIO_Port, &GPIO_InitStruct);
