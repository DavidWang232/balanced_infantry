...
//
#define BODY_MASS            (4.9f)      // (kg)机身重量
#define WHEEL_MASS           (0.75f)      // (kg)轮子重量
#define WHEEL_RADIUS         (0.077f)    // (m)轮子半径
#define WHEEL_START_TORQUE   (0.3f)      // (Nm)轮子起动力矩
#define WHEEL_BASE           (0.51175f)  // (m)驱动轮轴距

#define J0_ANGLE_OFFSET     (M_PI_2) // (rad)关节0角度偏移量(电机0点到水平线的夹角)
#define J1_ANGLE_OFFSET     (0.0f)         // (rad)关节1角度偏移量(电机0点到水平线的夹角)

#define J2_ANGLE_OFFSET     (M_PI_2)  // (rad)关节2角度偏移量(电机0点到水平线的夹角)
#define J3_ANGLE_OFFSET     (0)        // (rad)关节3角度偏移量(电机0点到水平线的夹角)
...
#define MAX_DELTA_ROD_ANGLE (2.5f) // (rad)腿摆角最大变化量
...
#define MAX_J0_ANGLE  (2.3f) // (rad)关节角度上限
#define MAX_J1_ANGLE  (2.3f) // (rad)关节角度上限

#define MAX_J2_ANGLE  (2.3f) // (rad)关节角度上限
#define MAX_J3_ANGLE  (2.3f) // (rad)关节角度上限
...
#define MIN_J0_ANGLE (-2.3f) // (rad)关节角度下限
#define MIN_J1_ANGLE (-2.3f) // (rad)关节角度下限
#define MIN_J2_ANGLE (-2.3f) // (rad)关节角度下限
#define MIN_J3_ANGLE ( -2.3f) // (rad)关节角度下限
...
// 起立模式轮速环pid
#define KP_CHASSIS_WHEEL_STAND_UP_0       (5.5f)
#define KI_CHASSIS_WHEEL_STAND_UP_0       (0.1f)
#define KD_CHASSIS_WHEEL_STAND_UP_0       (0.0f)
#define MAX_IOUT_CHASSIS_WHEEL_STAND_UP_0 (500.0f)
#define MAX_OUT_CHASSIS_WHEEL_STAND_UP_0  (3000.0f)

#define KP_CHASSIS_WHEEL_STAND_UP_1       (13.5f)
#define KI_CHASSIS_WHEEL_STAND_UP_1       (0.1f)
#define KD_CHASSIS_WHEEL_STAND_UP_1       (0.0f)
#define MAX_IOUT_CHASSIS_WHEEL_STAND_UP_1 (500.0f)
#define MAX_OUT_CHASSIS_WHEEL_STAND_UP_1  (3000.0f)
// 云台跟随用的pid
