...
extern const RC_ctrl_t * get_remote_control_tuchaun_point(void);
extern bool GetYkqRcOffline(void);
extern void ModifyUsart1DebugDataPackage(uint8_t index, float data, const char * name);
